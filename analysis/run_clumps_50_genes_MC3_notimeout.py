...
import re
import subprocess
from clumps.wolF.tasks import clumps_workflow #_localize_maf_only
import wolf
...
run_name = 'run_clumps_50_genes_MC3_10000000_perms_notimeout_recap'


wolf.utils.set_log_path('./%s_%s.log' % (run_name,datetime.today()))

with wolf.WolfWorkflow(
        workflow = clumps_workflow, #_localize_maf_only,#(maf,sampler),
        #run_name = run_name,
